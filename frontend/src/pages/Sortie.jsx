    ...
    <div>
      ...
      <div className="card" style={{ padding: 0, overflow: 'hidden', marginBottom: 14 }}>
        <table className="data-table">
          <thead>
            <tr>
              ...
              <th style={{ width: 120, textAlign: 'right' }}>Prix unit. (D.A)</th>
            ...
            {lignes.map(l => (
              <tr key={l.id}>
                ...
                <td style={{ textAlign: 'right', fontWeight: 600 }}>
                  {l.unitPrice && l.quantity ? (parseFloat(l.unitPrice) * parseFloat(l.quantity)).toFixed(2) + ' D.A' : '—'}
                </td>
                <td>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: 20, padding: '12px 16px', borderTop: '1px solid #e8e7e0' }}>
          ...
          <span style={{ fontSize: 22, fontWeight: 700 }}>{total.toFixed(2)} D.A</span>
        </div>
      </div>
