...
public class ProduitController {
    ...
    @GetMapping
    public List<Produit> getAll() { return repo.findAll(); }
    ...
    @PostMapping
    public Produit create(@RequestBody Produit produit) { return repo.save(produit); }

    @PutMapping("/{id}")
    public ResponseEntity<Produit> update(@PathVariable Integer id, @RequestBody Produit data) {
